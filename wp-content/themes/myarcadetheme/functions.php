...
function myarcadetheme_sidebar()
{
  ...
  if (is_active_sidebar("{$sidebar}-sidebar")) {
    ...
    if ('others' == $sidebar) {
      ...
      the_widget('WP_Widget_MABP_Recent_Games', 'title=' . __('Recent Games', 'myarcadetheme') . '&limit=12', 'before_title=<div class="titl"><h3>&after_title=</h3></div>&before_widget=<div id="mabp_recent_games" class="blk-cn widget_mabp_recent_games">&after_widget=</div>');

      the_widget('WP_Widget_MABP_Random_Games', 'title=' . __('Featured Games', 'myarcadetheme') . '&limit=12&wcategory=0', 'before_title=<div class="titl"><h3>&after_title=</h3></div>&before_widget=<div id="mabp_random_games" class="blk-cn widget_mabp_random_games">&after_widget=</div>');
    } else {
